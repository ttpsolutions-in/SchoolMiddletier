...
namespace schools.Controllers
{
    ...
    */
    public class AppUsersController : ODataController
    {
        ...
        // GET: odata/AppUsers(5)/MasterDataOrg
        [EnableQuery]
        public SingleResult<MasterData> GetMasterDataOrg([FromODataUri] short key)
        {
            return SingleResult.Create(db.AppUsers.Where(m => m.ApplicationUserId == key).Select(m => m.MasterDataOrg));
        }
